...
def generate_objects_automated_py(
    ...
    algo_class_list = definition_df[(definition_df['Process']=='Algorithm Categorization')&(definition_df['Categorization']!='Process Step')]['Word'].unique().tolist()
    ...
    ml_model_tax_list = definition_df[definition_df['Process']=='ML Model Taxonomy']['Word'].tolist()
    method_list = definition_df[definition_df['Process']=='Method']['Word'].tolist()
    func_list = definition_df[definition_df['Process']=='Function']['Word'].tolist()
    lp_list = definition_df[definition_df['Process']=='Learning Paradigm']['Word'].tolist()
...
object_dict['ml_model_tax_list'] = {{
    ...
    'publish':0,
    'python_object':{ml_model_tax_list}
        }}
