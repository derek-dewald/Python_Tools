...
function_notes = {
    'Name':'Connections',
    'Description': "Functions which Interact with External Datasources, APIs, websites. For Functions which work with Local Elements refer to Shared Folder",
    'Date Last Updated':datetime.datetime(2025,10,27),
    'Other Notes':""
}
import pandas as pd
import numpy as np
