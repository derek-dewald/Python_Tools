...
def PlotVectorizedImage(data,x=28,y=28):
    '''
    Function to Simply Return the Visualization of a Vectorized Represnetation. 
    Created to view MNist Data

    Parameters:
        data (np.array): Data
        x(int): Length of Array
        y(int): Width of Array
